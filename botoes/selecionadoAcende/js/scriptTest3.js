...
let btn1 = function () {
    ...
    document.getElementById('btn2').setAttribute('class', 'btn'); // remove o class
    document.getElementById('btn3').setAttribute('class', 'btn'); // remove o class   
}

let btn2 = function () {
    document.getElementById('btn2').setAttribute('class', 'btn active'); // atribui um class
    document.getElementById('btn1').setAttribute('class', 'btn'); // remove o class
    document.getElementById('btn3').setAttribute('class', 'btn'); // remove o class
}
let btn3 = function () {
    
    document.getElementById('btn3').setAttribute('class', 'btn active'); // atribui um class
    document.getElementById('btn1').setAttribute('class', 'btn'); // remove o class
    document.getElementById('btn2').setAttribute('class', 'btn'); // remove o class
